...
def generated_day(bw):
    ...
    # Using the corrected and simplified meal generation logic
    meal = {
        "probability": [0.98, 0.95, 0.98, 0.95, 0.98],
        "meantime": [t * 60 for t in [7.5, 10.5, 12.5, 16, 18.5]],
        ...
        "meanamount": [g * bw for g in [1.0, 0.4, 1.2, 0.5, 1.1]],
...
class MealGenerator:
    ...
    def create_meal_scenario(self, bw):
        ...
        meals = [(event[1], event[0]) for event in meal_events]  # Use event[1] (time) not event[2] (duration)
