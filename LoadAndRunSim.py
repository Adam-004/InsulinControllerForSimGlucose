...
def main():
    ...
    while True:
        ...
        try:
            choice = int(input(f"Enter a number (1-{len(model_types)}): "))
    ...
    trainer = ModelTrainer(lowenv, innerenv, highenv, config, model_save_path=env_mgr.path_to_results)
